...
BUSINESS_QUESTIONS_AND_QUERIES = """
...
with open('/home/claude/task2/sql_queries/business_queries.sql', 'w') as f:
    f.write(BUSINESS_QUESTIONS_AND_QUERIES)

print("="*80)
print("SQL QUERIES FOR BUSINESS INTELLIGENCE")
print("="*80)
print("\n✓ Generated 15 comprehensive SQL queries")
print("✓ Queries saved to: sql_queries/business_queries.sql")
print("\nQuery Categories:")
print("  • Product Analysis (5 queries)")
print("  • Temporal Analysis (6 queries)")
print("  • Revenue Analysis (4 queries)")
print("\nAll queries include:")
print("  ✓ Filtering and aggregation")
print("  ✓ Multi-table join logic")
